...
\begin{Exercise}[title={Regular Polygons Sharing a Side}, difficulty=1, label=4b1 ]
	In the figure below, the regular nonagon and the regular heptagon share a side. Find the measures of $\angle ADN$ and $\angle AND$.
		\begin{figure}[H]
			\includegraphics[scale=.5]{fig/a.png}
		\end{figure}
	\hfill \emph{solution} \refAnswer{4b1}
